						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								...
								<TR>
									<TD>
										<TABLE id=grid
											style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; 
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<%-- <a href="${pageContext.request.contextPath }/editCustomer.action?custId=${customer.cust_id}">修改</a> --%>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/deleteCustomer.action?custId=${customer.cust_id}">删除</a>
													</TD>
												</TR>
